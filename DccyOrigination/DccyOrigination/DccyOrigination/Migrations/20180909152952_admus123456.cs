...
{
    public partial class admus123456 : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AdmDepGuid = table.Column<string>(nullable: true),
                    AdmRoleGuid = table.Column<string>(nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    RoleGuidOrName = table.Column<string>(nullable: true),
                    DepGuidOrName = table.Column<string>(nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AdmUserGuid = table.Column<string>(nullable: true),
                    AdmDepGuid = table.Column<string>(nullable: true)
                },
                constraints: table =>
                {
